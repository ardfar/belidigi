                            ...
                            <div class="layout__inner" style="border-collapse: collapse; display: table; width: 100%; background-color: #fafafa;">
                                <div class="column" style="text-align: left; color: #595959; font-size: 14px; line-height: 21px; font-family: Lato,Tahoma,sans-serif;">
                                    ...
                                    <div style="margin-left: 20px; margin-right: 20px;">
                                        ...
                                        <div style="Margin-left: 20px;Margin-right: 20px;">
                                            <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                                <h1 class="size-30" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #b59859;font-size: 26px;line-height: 34px;text-align: center;" lang="x-size-30">&nbsp;<span style="text-decoration: inherit;color: #2d3748;">Selamat Datang Di Belidigi</span></h1>
                                                <p class="size-16" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: center;font-weight:bolder" lang="x-size-16">Halo Kak {{ $dataUser->nama }}</p>
                                                <p class="size-16" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: center;" lang="x-size-16">Terima Kasih sudah bergabung di belidigi. Sekarang kamu sudah resmi menjadi sobatDigi dan bisa transaksi hemat di Belidigi. Semakin banyak transaksi, semakin hemat biayanya</p>
                                                <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                                                    <a style="border-radius: 4px;display: block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #142e71;font-family: PT Serif, Georgia, serif;" href="">Buka Halaman Profil</a>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                    ...
                                    <div style="margin-left: 20px; margin-right: 20px; margin-bottom: 24px;">
                                        <div style="mso-line-height-rule: exactly; mso-text-raise: 11px; vertical-align: middle;">
                                            <p class="size-17" lang="x-size-17" style="margin-top: 20px; margin-bottom: 0; font-size: 17px; line-height: 26px;">Terima Kasih sobatDigi, 
                                                <br>
                                            ...
                                            <br>    
                                            <p class="size-17" lang="x-size-17" style="margin-top: 0; margin-bottom: 0; font-size: 17px; line-height: 26px;">Stay Connected:&nbsp;</p>
                            ...
                            <div class="layout__inner" style="border-collapse: collapse; display: table; width: 100%; background-color: #fafafa;">
                                <div class="column" style="text-align: left; color: #595959; font-size: 14px; line-height: 21px; font-family: Lato,Tahoma,sans-serif;">
                                    ...
                                    <div style="margin-left: 20px; margin-right: 20px;">
                                        ...
                                        <div style="Margin-left: 20px;Margin-right: 20px;">
                                            <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                                <h1 class="size-30" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #b59859;font-size: 26px;line-height: 34px;text-align: center;" lang="x-size-30">&nbsp;<span style="text-decoration: inherit;color: #2d3748;">Verifikasi Email-Mu</span></h1>
                                                <p class="size-16" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: center;font-weight:bolder" lang="x-size-16">Terima kasih sudah mendaftar</p>
                                                <p class="size-16" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: center;" lang="x-size-16">Sebelum kamu bisa menggunakan akun-mu sepenuhnya, harap verifikasi email-mu dengan mengklik tombol dibawah ini.</p>
                                                <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                                                    <a style="border-radius: 4px;display: block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #142e71;font-family: PT Serif, Georgia, serif;" href="{{ route('email_verify',[$dataUser->username]) }}">Verifikasi</a>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                    ...
                                    <div style="margin-left: 20px; margin-right: 20px; margin-bottom: 24px;">
                                        <div style="mso-line-height-rule: exactly; mso-text-raise: 11px; vertical-align: middle;">
                                            <p class="size-17" lang="x-size-17" style="margin-top: 20px; margin-bottom: 0; font-size: 17px; line-height: 26px;">Terima Kasih sudah mendaftar, 
                                                <br>
                                                <strong>Farras Arrafi</strong> 
                                                <br>
                                                <em>CEO - BeliDigi Chief Officer</em>
