      ...
      <div class="flex flex-wrap justify-center -mx-4">
        <div class="w-full px-4">
          <div class=" relative rounded overflow-hidden z-20 mb-[60px] h-[300px] md:h-[400px] lg:h-[500px] wow fadeInUp " data-wow-delay=".1s " >
            <img src="@yield('blog_main_image')" alt="image" class="w-full h-full object-cover object-center" />
                ...
                <div class="flex flex-wrap items-center p-4 sm:p-8 pb-4">
                    <div class="flex items-center mb-4 mr-5 md:mr-10">
                        ...
                        <p class="text-base text-white font-medium">
                            By
                            <a href="javascript:void(0)" class="text-white hover:opacity-70" > @yield('blog_writer') </a>
                        </p>
                    </div>
          ...
          <div class="flex flex-wrap -mx-4">
                ...
                <div class="flex flex-wrap items-center -mx-4 mb-12">
                    <div class="w-full md:w-1/2 px-4">
                        <div class=" flex items-center flex-wrap mb-8 md:mb-0 wow fadeInUp " data-wow-delay=".1s" >
                            ...
                            <a href="javascript:void(0)" class=" block py-2 px-5 mb-2 bg-primary bg-opacity-5 text-primary rounded text-xs font-medium hover:bg-opacity-100 hover:text-white " >
                                Info
                            </a>
                        </div>
                    </div>
            ...
            <div class="w-full lg:w-4/12 px-4" id="sidebar">
              <div>
                <div class=" mb-12 bg-primary rounded relative overflow-hidden text-center py-[60px] px-11 lg:px-8 wow fadeInUp " data-wow-delay=".1s " >
                  <h3 class="font-semibold text-white mb-2 text-2xl">
                    Tetap Update
                  </h3>
                  <p class="text-base text-white mb-8">
                    Masukan emailmu dan dapatkan pembaharuan setiap hari
                  </p>
                  <form action="{{ route('add_email_sub') }}">
                    @csrf
                    @method('PUT')
                    <input id="email" name="email" type="email" placeholder="Alamat email-mu" class=" w-full text-center h-[50px] text-sm font-medium bg-white bg-opacity-20 placeholder-white text-white rounded mb-4 outline-none border border-transparent focus-visible:shadow-none focus:border-white " />
                    <input type="submit" value="Subscribe Now" class=" w-full text-center h-[50px] text-sm font-medium text-white rounded mb-6 bg-[#13C296] cursor-pointer hover:shadow-lg hover:bg-opacity-90 transition duration-300 ease-in-out " />
                  </form>
                  <p class="text-sm font-medium text-white">
                    Jangan khawatir, kami tidak akan spam emailmu
                  </p>
                ...
                {{-- <div class="rounded overflow-hidden mb-12 wow fadeInUp" data-wow-delay=".1s" >
