        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
            <div class="w-full mb-10">
              <a href="{{ route('/') }}" class="inline-block max-w-[160px] mb-6" >
                <img src="{{ asset('images/logo/logo-white.svg') }}" alt="logo" class="max-w-full"/>
              </a>
              <p class="text-base text-[#f3f4fe] mb-7">
                Sebuah platform digital yang menyediakan berbagai kemudahan dalam satu platform.
              </p>
          ...
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12 px-4">
            <div class="w-full mb-10">
              <h4 class="text-white text-lg font-semibold mb-9"> Utama </h4>
              <ul>
                <li>
                  <a href="{{ route('/') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Beranda </a>
                </li>
                <li>
                  <a href="{{ route('tentang') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Tentang </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Testimonial </a>
                </li>
                <li>
                  <a href="{{ route('kontak') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Kontak Kami </a>
                </li>
              </ul>
            </div>
          </div>
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12 px-4">
            <div class="w-full mb-10">
              <h4 class="text-white text-lg font-semibold mb-9"> Fitur </h4>
              <ul>
                <li>
                  <a href="javascript:void(0)" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Cara Kerja </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Kebijakan Privasi </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Ketentuan Layanan </a>
                </li>
                <li>
                  <a href="javascript:void(0)" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Kebijakan Refund </a>
                </li>
              </ul>
            </div>
          </div>
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12 px-4">
            <div class="w-full mb-10">
              <h4 class="text-white text-lg font-semibold mb-9"> Produk Kami </h4>
              <ul>
                <li>
                  <a href="{{ route('transfer-uang') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Transfer Antar Bank </a>
                </li>
                <li>
                    <a href="{{ route('bayar-virtual-account') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Bayar Virtual Account </a>
                  </li>
                <li>
                  <a href="{{ route('pulsa-kuota') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Isi Pulsa & Kuota </a>
                </li>
                <li>
                  <a href="{{ route('lisensi-digital') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Lisensi Digital </a>
                </li>
                <li>
                  <a href="{{ route('topup-e-wallet') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Top Up E-Wallet </a>
                </li>
                <li>
                    <a href="{{ route('jasa-sosmed') }}" class=" inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2 " > Jasa Sosial Media </a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="w-full md:w-2/3 lg:w-1/2 px-4">
              <div class="my-1">
                <div class=" flex items-center justify-center md:justify-start -mx-3 " >
                  <a href="javascript:void(0)" class="text-base text-[#f3f4fe] hover:text-primary px-3" > Privacy policy </a>
                  <a href="javascript:void(0)" class="text-base text-[#f3f4fe] hover:text-primary px-3" > Legal notice </a>
                  <a href="javascript:void(0)" class="text-base text-[#f3f4fe] hover:text-primary px-3" > Terms of service </a>
                </div>
              </div>
            </div>
            <div class="w-full md:w-1/3 lg:w-1/2 px-4">
              <div class="flex justify-center md:justify-end my-1">
                <p class="text-base text-[#f3f4fe]">
                  ...
                  <a href="https://tailgrids.com" rel="nofollow noopner" target="_blank" class="text-primary hover:underline" > TailGrids and UIdeck </a>
                </p>
              </div>
            </div>
          </div>
