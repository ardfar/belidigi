...
@section('title','Reset Password - Belidigi')
            ...
            <div class="w-full px-4">
                <div class="max-w-[525px] mx-auto text-center bg-white rounded-lg relative overflow-hidden py-14 px-8 sm:px-12 md:px-[60px] wow fadeInUp" data-wow-delay=".15s">
                    ...
                    <form action="{{ route('send_reset_link') }}" method="POST">
                        ...
                        <div class="mb-10">
                            <input type="submit" value="Reset Password" class="w-full rounded-md border bordder-primary py-3 px-5 bg-primary text-base text-white cursor-pointer hover:shadow-md transition duration-300 ease-in-out" />
                        </div>
                    </form>
