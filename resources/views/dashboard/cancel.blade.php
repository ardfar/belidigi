...
@section('title','Proses Pesanan - BeliDigi')
@section('content')
<div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">
            Data : Pesanan Yang Dibatalkan Oleh Pengguna
        </h2>
    </div>
    <!-- BEGIN: HTML Table Data -->
    <div class="intro-y box p-5 mt-5">
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form action="{{ route('cancelSearch') }}" class="xl:flex sm:mr-auto" >
                ...
                <a href="{{ route('cancel') }}" class="hidden" id="areset"></a>
            </form>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a href="{{ route('cancelDetail',[$generalInfo->jenisTransaksi,$generalInfo->idTransaksi]) }}" class="flex items-center mr-3 text-theme-12"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Detail </a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
